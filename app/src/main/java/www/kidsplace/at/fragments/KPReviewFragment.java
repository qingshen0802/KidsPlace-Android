...
public class KPReviewFragment extends Fragment {
    ...
    private void setupList() {
        if (list.getAdapter() != null) {
            ...
            adapter = new KPPlacesAdapter(getContext(), places, Constants.PLACE_REVIEW_OPTION);
    ...
    @OnClick(R.id.activity_review_bt_menu)
